...
INSERT INTO TOPIC(title, message, created_at, status, user_id, course_id) VALUES('Dúvida', 'O que é useState?', '2019-05-05 18:00:00', ' NOT_ANSWERED', 1, 1);
INSERT INTO TOPIC(title, message, created_at, status, user_id, course_id) VALUES('Dúvida', 'Não sei o verbo to be', '2019-05-05 18:00:00', ' NOT_ANSWERED', 2, 2);
INSERT INTO TOPIC(title, message, created_at, status, user_id, course_id) VALUES('Dúvida', 'O que é join table', '2019-05-05 18:00:00', ' NOT_ANSWERED', 3, 3);
...
INSERT INTO TOPIC(title, message, created_at, status, user_id, course_id) VALUES('Dúvida', 'O que uma stream em java', '2019-05-05 18:00:00', ' NOT_ANSWERED', 2, 4);
